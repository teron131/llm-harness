...
from .types import ImageStatsSelectedOptions, ImageStatsSelectedPayload
...
def save_image_stats_selected(
    ...
    save_image_stats_selected_to_path(payload, output_path)
...
def get_image_stats_selected(
    ...
    try:
        ...
        list_payload: ImageStatsSelectedPayload = {
            "fetched_at_epoch_seconds": fetched_at,
            "models": models,
        }

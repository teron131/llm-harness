...
def _is_positive_finite(value: Any) -> bool:
    """Return whether the current value is valid for Artificial Analysis stats aggregation."""
...
def _weighted_mean(pairs: list[tuple[float | None, float]]) -> float | None:
    """Compute a finite-aware aggregate for Artificial Analysis stats aggregation."""
